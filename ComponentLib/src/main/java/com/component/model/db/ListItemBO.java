...
public class ListItemBO extends HttpDataEntity implements Serializable, Cloneable {
    ...
    public String cName;
    public int rId;
    public int localData; //是否是本地数据 0 不是，1是
    public String rName;
    public String aDate;
    ...
    @Generated(hash = 2096851677)
    public ListItemBO(Long id, String itemId, String aId, String aType, int cType, int cId,
            String cName, int rId, int localData, String rName, String aDate, int ctime,
            int mtime, float amount, String remark, String icon, String color, String uid,
            String nickname, String year, String month, String day) {
        this.id = id;
        this.itemId = itemId;
        this.aId = aId;
        this.aType = aType;
