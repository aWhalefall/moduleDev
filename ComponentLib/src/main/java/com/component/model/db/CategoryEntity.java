...
public class CategoryEntity extends HttpDataEntity implements Serializable, Cloneable {
    ...
    @Unique
    public int rId;
    public int localData; //是否是本地数据 0 是，1不是
    public String cName;
    public String rName;
    public String aId;
    public int cType;
    ...
    @Generated(hash = 2128355146)
    public CategoryEntity(Long id, String uid, int cId, int rId, int localData, String cName,
            String rName, String aId, int cType, String color, String icon) {
        this.id = id;
        this.uid = uid;
        this.cId = cId;
        this.rId = rId;
