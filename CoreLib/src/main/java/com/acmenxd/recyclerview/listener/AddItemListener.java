                            ...
                            if (mRecyclerView.getScrollState() == RecyclerView.SCROLL_STATE_IDLE) {
                                if (mItemCallBack != null) {
                                    ...
                                    if (child instanceof SwipeMenuLayout &&
                                            (((SwipeMenuLayout) child).isMenuOpen() || ((SwipeMenuLayout) child).isLoseOnceTouch())) {
                                        isMenuOpen = true;
                                    }
                                    ...
                                    if (child != null && child.isEnabled() && !isMenuOpen && !isGroup) {
                                        ...
                                        if (viewPosition == mRecyclerView.NO_POSITION) {
                                    ...
                                    if (mItemCallBack.isLongEnabled()) {
                                        ...
                                        if (child != null && child.isEnabled() && !isMenuOpen) {
                                            ...
                                            if (viewPosition != mRecyclerView.NO_POSITION) {
                                                ...
                                                Logger.e("Recycle getChildAdapterPosition Return -1");
                                            }
        ...
        public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
            ...
            if (mRecyclerView.getScrollState() == RecyclerView.SCROLL_STATE_IDLE) {
                if (actionState == ItemTouchHelper.ACTION_STATE_DRAG) {
                    ...
                    Logger.v("AcmenXD", "item进入拖拽状态");
                } else if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE) {
                    if (mItemCallback != null) {
                        mItemCallback.setLongEnabled(false);
                    }
                    Logger.v("AcmenXD", "item进入滑动状态");
                } else if (actionState == ItemTouchHelper.ACTION_STATE_IDLE) {
                    Logger.v("AcmenXD", "item无状态");
                }
            }
        }
